...
- The indicator **Scale** now goes down to 40% (it was 65%), and the switcher themes, which show every slot at once, go down to 25%. Use the theme's Text size to keep small bubbles readable.
